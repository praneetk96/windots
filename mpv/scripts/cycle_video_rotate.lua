...
------------------------------------------------
-- Keybind to rotate video
------------------------------------------------

-- mp.add_key_binding(nil, "Cycle_Video_Rotate", cycle_video_rotate)
mp.add_key_binding("Alt+RIGHT", "rotate_right", function() cycle_video_rotate("clockwise") end)
mp.add_key_binding("Alt+LEFT", "rotate_left", function() cycle_video_rotate("counter-clockwise") end)
